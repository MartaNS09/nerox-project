          ...
          <div className="row justify-content-center">
            <div className="col-lg-10">
              <div className="career-hero-content text-center">
                <h1 className="title" style={{color: 'white', fontSize: '3rem', marginBottom: '30px', fontWeight: '700'}}>
                  Карьера в NEROX
                </h1>
                <div className="text" style={{color: 'rgba(255,255,255,0.9)', fontSize: '1.3rem', lineHeight: '1.8'}}>
